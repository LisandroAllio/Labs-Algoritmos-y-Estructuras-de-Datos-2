...
char *string_clone(const char *str) {
    char *clone=NULL;
    clone = calloc(strlen(str), sizeof(char)); //Reservo memoria para una cadena de largo strlen(str) donde cada elemento ocupa sizeof(char)
    strcpy(clone, str); //Copia el string apuntado por str y lo guarda en la memoria apuntada por clone
    return clone;
}
