...
/**
 * @brief Translate the enumeration value of type month_ into a string.
 * @param[in] month of tipe month_t
 */
const char* getMonthName(month_t month);

/**
 * @brief Write the content of the array 'a' into stdout. 
 * @details It has to use the function getMonthName to transforms each elemente of type months_t into strings.
 * @param[in] a array to dump in stdout
 */
